...
function dpattorney_scripts() {
    ...
    // Partner Cards CSS
    wp_enqueue_style(
        'dpattorney-partner-cards',
        DPATTORNEY_URI . '/assets/css/partner-cards.css',
        array('dpattorney-style'),
        DPATTORNEY_VERSION
    );
...
function dpattorney_customize_register($wp_customize) {
    ...
    $wp_customize->add_section('dpattorney_organization', array(
        'title' => __('Organization Information', 'dpattorney'),
        'priority' => 31,
    ));

    // Organization Address
    $wp_customize->add_setting('dpattorney_address_street', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('dpattorney_address_street', array(
        'label' => __('Street Address', 'dpattorney'),
        'section' => 'dpattorney_organization',
        'type' => 'text',
    ));

    $wp_customize->add_setting('dpattorney_address_city', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('dpattorney_address_city', array(
        'label' => __('City', 'dpattorney'),
        'section' => 'dpattorney_organization',
        'type' => 'text',
    ));

    $wp_customize->add_setting('dpattorney_address_state', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('dpattorney_address_state', array(
        'label' => __('State/Province', 'dpattorney'),
        'section' => 'dpattorney_organization',
        'type' => 'text',
    ));

    $wp_customize->add_setting('dpattorney_address_zip', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('dpattorney_address_zip', array(
        'label' => __('Postal Code', 'dpattorney'),
        'section' => 'dpattorney_organization',
        'type' => 'text',
    ));

    $wp_customize->add_setting('dpattorney_address_country', array(
        'default' => 'ID',
        'sanitize_callback' => 'sanitize_text_field',
    ));

    $wp_customize->add_control('dpattorney_address_country', array(
        'label' => __('Country Code (e.g., ID, SG, MY)', 'dpattorney'),
        'section' => 'dpattorney_organization',
        'type' => 'text',
    ));

    // Organization Logo
    $wp_customize->add_setting('dpattorney_org_logo', array(
        'default' => '',
        'sanitize_callback' => 'esc_url_raw',
    ));

    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'dpattorney_org_logo', array(
        'label' => __('Organization Logo', 'dpattorney'),
        'section' => 'dpattorney_organization',
        'settings' => 'dpattorney_org_logo',
    )));
}
...
require_once DPATTORNEY_DIR . '/inc/schema-markup.php';
